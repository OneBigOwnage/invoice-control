                    ...
                    <div class="row">
                        ...
                        <div class="col-2">
                            <div class="form-group">
                                <label>Time</label>
                                <input type="text" name="time" class="form-control" placeholder="HH:MM" value="{{ old('time') }}">
                            </div>
                        </div>
                        ...
                        <div class="col-2">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" name="tax_percentage" class="form-control" placeholder="Tax" value="{{ old('tax_percentage') }}">
                        ...
                        <div class="col-3">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="sub_total_calculated" class="form-control" readonly value="-">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="task_performed_date" class="form-control" autocomplete="off" value="{{ old('task_performed_date') }}">
                            </div>
                        </div>
