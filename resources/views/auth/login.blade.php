...
<head>
    ...
    <title>Invoice Control - Login</title>
    <link href="/ext_assets/css/style.min.css" rel="stylesheet">
</head>
            ...
            <div class="auth-box bg-dark border-top border-secondary">
                <div id="loginform">
                    <div class="text-center p-t-20 p-b-20">
                        <span class="db"><img src="/ext_assets/images/logo.png" alt="logo" /></span>
                    </div>
                    <!-- Form -->
                        ...
                        <div class="row p-b-30">
                            <div class="col-12">
                                <div class="input-group mb-3">
                                    ...
                                    <input name="email" type="email" class="form-control form-control-lg" placeholder="Email address" aria-label="Email address" aria-describedby="basic-addon1" required="" autofocus>
                                </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
